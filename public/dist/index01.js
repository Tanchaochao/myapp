...
/***/ function(module, exports, __webpack_require__) {
	...
	var GrandpaComponent = function (_React$Component) {
		_inherits(GrandpaComponent, _React$Component);
	
		function GrandpaComponent(props) {
			_classCallCheck(this, GrandpaComponent);
	
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GrandpaComponent).call(this, props));
	
			_this.displayName = 'GrandpaComponent';
			return _this;
		}
	
		_createClass(GrandpaComponent, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(FatherComponent, null)
				);
			}
		}]);
	
		return GrandpaComponent;
	}(_react2.default.Component);
	
	var FatherComponent = function (_React$Component2) {
		_inherits(FatherComponent, _React$Component2);
	
		function FatherComponent(props) {
			_classCallCheck(this, FatherComponent);
	
			var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(FatherComponent).call(this, props));
	
			_this2.displayName = 'FatherComponent';
			return _this2;
		}
	
		_createClass(FatherComponent, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
	...
	var ChildComponent = function (_React$Component3) {
		_inherits(ChildComponent, _React$Component3);
	
		function ChildComponent(props) {
			_classCallCheck(this, ChildComponent);
	
			var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(ChildComponent).call(this, props));
	
			_this3.displayName = 'ChildComponent';
			return _this3;
		}
	...
	(0, _reactDom.render)(_react2.default.createElement(GrandpaComponent, null), document.getElementById("app"));
