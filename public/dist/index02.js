...
/***/ function(module, exports, __webpack_require__) {
		...
		_createClass(MessageBox, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement("input", { value: this.state.title, ref: "visible", type: "text", onChange: function onChange() {
							return _this2.setTitle();
						} }),
					_react2.default.createElement(SubMessageBox, { onSetTitle: function onSetTitle(text) {
	...
	var SubMessageBox = function (_React$Component2) {
		_inherits(SubMessageBox, _React$Component2);
	
		function SubMessageBox(props) {
			_classCallCheck(this, SubMessageBox);
	
			var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(SubMessageBox).call(this, props));
	
			_this3.displayName = 'SubMessageBox';
			return _this3;
		}
	
		_createClass(SubMessageBox, [{
			key: "setTitle",
			...
			value: function render() {
				...
				return _react2.default.createElement(
					"div",
					{ className: "subMessageBox" },
					_react2.default.createElement(
						"h3",
						null,
						"SubMessageBox"
					),
					_react2.default.createElement("input", { onClick: this.props.setVisible, type: "button", value: "点击" }),
					_react2.default.createElement("br", null),
					_react2.default.createElement("input", { value: this.props.msg, ref: "title", type: "text", onChange: function onChange() {
							return _this4.setTitle();
						} }),
					_react2.default.createElement(
						"div",
						null,
		...
		return SubMessageBox;
	}(_react2.default.Component);
	
	(0, _reactDom.render)(_react2.default.createElement(MessageBox, null), document.getElementById("app"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".messageBox {\r\n\tborder: 1px solid red;\r\n}\r\n\r\n.subMessageBox {\r\n\tborder: 1px solid black;\r\n}", ""]);
