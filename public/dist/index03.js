...
/***/ function(module, exports, __webpack_require__) {
	...
	var TopComponent = function (_React$Component) {
		...
		function TopComponent(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TopComponent).call(this, props));
	
			_this.displayName = 'TopComponent';
			//getInitialState
			_this.state = {
		...
		_createClass(TopComponent, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement('input', { type: 'button', value: 'start', onClick: function onClick() {
							return _this3.start();
						} }),
					_react2.default.createElement('input', { type: 'button', value: 'unmount', onClick: function onClick() {
							return _this3.unmount();
						} }),
					_react2.default.createElement('input', { type: 'button', value: 'doUpdate', onClick: function onClick() {
							return _this3.doUpdate();
						} }),
	...
	var SubMessage = function (_React$Component2) {
		_inherits(SubMessage, _React$Component2);
	
		function SubMessage(props) {
			_classCallCheck(this, SubMessage);
	
			var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(SubMessage).call(this, props));
	
			_this4.displayName = 'SubMessage';
			return _this4;
		}
	...
	(0, _reactDom.render)(_react2.default.createElement(TopComponent, data), document.getElementById("app"));
